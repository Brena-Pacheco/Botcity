...
def acessar_site(bot):
    ...
    bot.print_pdf('C:\\Users\\matutino\\Desktop\\ProvaBot\\botproduto\\pdf\\SiteProduto.pdf')
...
def main():
    ...
    arq_excel = 'C:\\Users\\matutino\\Desktop\\ProvaBot\\botproduto\\planilha\\RelacaoProduto.xlsx'
    sheet = 'produto'  
    ...
    lista_pdf = []
    lista_pdf.append('C:\\Users\\matutino\\Desktop\\ProvaBot\\botproduto\\pdf\\ListaProduto.pdf')
    lista_pdf.append('C:\\Users\\matutino\\Desktop\\ProvaBot\botproduto\\pdf\\SiteProduto.pdf')
    pdf.merge_pdfs(lista_pdf,'C:\\Users\\matutino\\Desktop\\ProvaBot\\botproduto\\pdf\\Produtos.pdf')
    
    print('Enviando E-mail para a lista de usuario com arquivo Produtos.pdf em anexo.')
    arq_anexo = 'C:\\Users\\matutino\\Desktop\\ProvaBot\\botproduto\\pdf\\Produtos.pdf'
