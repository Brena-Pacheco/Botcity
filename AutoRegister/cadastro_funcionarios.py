...
def main():
    ...
    caminho_excel = r"C:\Users\matutino\Desktop\BotCity\AutoRegister\cadastro\funcionarios.xlsx"
    ...
    email_field.send_keys("brenaapacheco00@gmail.com")
    webbot.enter()
    webbot.wait(3000)

    password_field = webbot.find_element('//*[@id="password"]/div[1]/div/div[1]/input', By.XPATH)
    password_field.send_keys("Caninde2cid1")
    webbot.enter()
    webbot.wait(10000)
